...
intents = json.loads(open(r'C:/Users/Admin/OneDrive/Documents/bai_tap/xu_ly_ngon_ngu_tu_nhien/baikiemtradiemB/iD8uEDA/create_chatbot_using_python-main/create_chatbot_using_python-main/intents.json').read())
